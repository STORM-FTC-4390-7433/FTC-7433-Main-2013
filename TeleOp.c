...
#pragma config(Motor,  mtr_S4_C1_1,     hangLeft,      tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S4_C1_2,     conveyorDrive, tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S4_C2_1,     motorF,        tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S4_C2_2,     conveyorTurn,  tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S4_C3_1,     rightDrive,    tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S4_C3_2,     leftDrive,     tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S4_C4_1,     hangRight,     tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S4_C4_2,     flagDrive,     tmotorTetrix, openLoop)
...
{
	writeDebugStreamLine("%d", joystick.joy1_x1);
...
task main(){
	...
	while (true){
		...
		updateHangSys(hang, 20, joy2Btn(4), joy2Btn(2));
